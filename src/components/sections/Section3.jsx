...
const Section3 = () => {
  return (
    <>
      <NavigationButtons prevPath="/section2" nextPath="/section4" />
      <Section
  ...
  Constructor ფუნქციას."
      >
        ...
        <p>
          კონსტრუქტორი ფუნქცია არის ჩვეულებრივი ფუნქცია. განსხვავება მხოლოდ
          ისაა, რომ მისი სახელი იწყება დიდი ასოთი და მისი გამოძახება უნდა მოხდეს
          new ოპერატორის მეშვეობით.
        </p>
        <p>მაგალითი:</p>
        ...
        <ul className="list-group custom-list">
          ...
          <li className="list-group-item bg-light">
            ...
            ვამატებ firstName-ს და lastName ფროფერთიებს შესაბამისი
            მნიშვნელობებით.
          </li>
          <li className="list-group-item bg-light">
