  ...
  return (
    <Section heading={"რა არის ობიექტზე ორიენტირებული პროგრამირება (OOP)?"}>
      <p>
        ...
        წარმოადგენს, ასე ვთქვათ, საშენ მასალებს რომელთა ერთმანეთთან ინტერაქციით
        მიიღება სრული აპლიკაცია.
      </p>
      <p>
        ობიექტების ეს ინტერაქცია ხდება public interface-ის (API) მეშვეობით.
        Public ინტერფეისი არის იმ მეთოდების და ფროფერთიების ერთობლიობა, რომლებიც
        ხელმისაწვდომია ობიექტის გარეთ და გამოიყენება სხვა ობიექტებთან
        კომუნიკაციისთვის.
      </p>
      <p>
      ...
      <InnerContainer heading3="რა არის კლასები?">
        <p>
          კლასები არის ერთგვარი მოდელები, გეგმა, რომელიც გამოიყენება ობიექტების
          ანუ კლასის ინსტანციების შესაქმნელად, მასში აღწერილი საჭირო
        ...
        <ul className="list-group custom-list">
          ...
          <li className="list-group-item bg-light">
            ...
            <p>
              ...
              იყვნენ ხელმისაწვდომი კლასის გარეთ. შესაბამისად, ისინი არ იქნებიან
              public interface-ის ნაწილი. ასე შეგვიძლია გარკვეული მახასიათებლები
              დავიცვათ გარე ჩარევებისაგან;
            </p>
          </li>
          <li className="list-group-item bg-light">
            <h5>მემკვიდრეობა:</h5>
            ...
            <p>
              ამ კლასიდან, შემდეგ შეიძლება შეიქმნას მემკვიდრე კლასები, რომლებიც
              უფრო დაკონკრეტებული, სპეციალიზებული იქნებიან და თითოეული მათგანი
              დაამატებს რაიმე უნიკალურ თვისებას ან მეთოდს (სუპერკლასები და
              ქვეკლასები);
            </p>
          </li>
          <li className="list-group-item bg-light">
            <h5>პოლიმორფიზმი: </h5>
            <p>მემკვიდრე კლასმა შეიძლება შეცვალოს მშობელი კლასის მეთოდები</p>
          </li>
        </ul>
      </InnerContainer>
    </Section>
