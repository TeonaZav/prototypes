  ...
  return (
    <Section heading="ფროფერთი სახელწოდებით 'prototype'">
      ...
      <p>
        ...
        მასივი და ფუნქციაც. შესბამისად ფუნქციას აქვს ფროფერთიები. მათ შორის არის
        ფროფერთი "prototype", რომელიც არის ცარიელი ობიექტი.
      </p>
      <p>მათ შორის არის ფროფერთი "prototype", რომელიც არის ცარიელი ობიექტი.</p>
      <CodeEditor codeExample={codeExamples.example5} />
      <p>
        მებისმიერი ობიექტი, რომელიც შეიქმნება კონსტრუქტორი ფუნქციით, ავტომატურად
        მიიღებს წვდომას ყველა იმ ფროფერთიზე და მეთოდზე, რომელსაც განვსაზღვრავთ
        prototype-ობიექტში.
      </p>
